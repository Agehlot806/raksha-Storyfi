...
export const FONTS_I = {
  largeTitle: {fontFamily: 'Inter-Regular', fontSize: SIZES.largeTitle},
  h1: {fontFamily: 'Inter-Regular', fontSize: SIZES.h1, lineHeight: 36},
  h2: {fontFamily: 'Inter-Regular', fontSize: SIZES.h2, lineHeight: 30},
  h3: {fontFamily: 'Inter-Regular', fontSize: SIZES.h3, lineHeight: 22},
  h4: {fontFamily: 'Inter-Regular', fontSize: SIZES.h4, lineHeight: 22},
  h5: {fontFamily: 'Inter-Regular', fontSize: SIZES.h5, lineHeight: 22},
...
const appTheme = {COLORS, SIZES, FONTS_I};
